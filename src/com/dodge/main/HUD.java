...
public class HUD {
	...
	public void render(Graphics g){
		...
		g.fillRect(Game.iWidth - 264+3, 24+3, 240, 36);
		g.setColor(new Color (211,211,211,opacity));
		g.fillRect(Game.iWidth - 264, 24, 240, 36);
		g.setColor(new Color(62, (int)greenValue, 42, opacity));
		g.fillRect((int)Game.iWidth - 264, 24, (int)HEALTH*2, 36);
		
		// Multiplier bar
		g.setColor(new Color (0,0,0,opacity));
		g.fillRect(Game.iWidth - 264+3, 68+3, 240, 18);
		g.setColor(new Color (211,211,211,opacity));
		g.fillRect(Game.iWidth - 264, 68, 240, 18);
		g.setColor(new Color(255,255,42,opacity));
		g.fillRect((int)Game.iWidth - 264, 68, (int)MULTIPLIER, 18);
		
		// Speed boost bar
		g.setColor(new Color (0,0,0,opacity));
		g.fillRect(Game.iWidth - 264+3, 94+3, 240, 18);
		g.setColor(new Color (211,211,211,opacity));
		g.fillRect(Game.iWidth - 264, 94, 240, 18);
		g.setColor(new Color(55,155,255,opacity));
		g.fillRect((int)Game.iWidth - 264, 94, (int)BOOST*2, 18);
		
		// Text
		g.setFont(new Font("Ubuntu Mono", Font.PLAIN, 20)); 
		g.setColor(new Color(0,0,0, 100));
		//g.drawString("TIME : "+smin+":"+ssec+"."+sms, 24+2, (Game.iHeight/2-200)+24+2);
		g.drawString("PHASE: " + phase, 24+2, (Game.iHeight/2-200)+44+2);
		g.drawString("LEVEL: " + level, 24+2, (Game.iHeight/2-200)+64+2);
		g.drawString("MLTPL: " + multiplier, 24+2, (Game.iHeight/2-200)+84+2);
		g.drawString("SCORE: " + score, 24+2, (Game.iHeight/2-200)+104+2);
		
		g.setColor(new Color(122,122,122, 100));
		//g.drawString("TIME : "+smin+":"+ssec+"."+sms, 24, (Game.iHeight/2-200)+24);
		g.drawString("PHASE: " + phase, 24, (Game.iHeight/2-200)+44);
		g.drawString("LEVEL: " + level, 24, (Game.iHeight/2-200)+64);
		g.drawString("MLTPL: " + multiplier, 24, (Game.iHeight/2-200)+84);
		g.drawString("SCORE: " + score, 24, (Game.iHeight/2-200)+104);
